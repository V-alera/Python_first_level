...
def warning(message):
    bot.send_message(
        message.chat.id, f'Не понимаю. Введи: /help.')
...
def help(message):
    bot.send_message(
        message.chat.id, f'/start - начать сначала \n/main - главное меню\n/help - вызвать справку')
...
def main(message):
    if message.text == '/main':
        ...
        bot.send_message(
            message.chat.id, f'Не понимаю. Введите: /help.')
...
def change_name(message):
    ...
    bot.send_message(message.chat.id, f'{cr.retrive(name=name_it)}')
    bot.send_message(
        message.chat.id, f'Введите номер записи, которую хотите изменить')
...
def delete_surname(message):
    ...
    bot.send_message(message.chat.id, f'{cr.retrive(surname=surname_it)}')
    bot.send_message(
        message.chat.id, f'Введите номер записи, которую хотите удалить')
...
def delete_number(message):
    ...
    bot.send_message(
        message.chat.id, f'Контакт удален!')
